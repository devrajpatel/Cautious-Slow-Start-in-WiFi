...
TcpCubic::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::TcpCubic")
    ...
    .AddAttribute ("CautiousSlowStart", "Enable (true) or disable (false) Cautious Slow Start",
                   BooleanValue (true),
                   MakeBooleanAccessor (&TcpCubic::m_flagCSS),
                   MakeBooleanChecker ())
...
uint32_t
TcpCubic::CSlowStart (Ptr<TcpSocketState> tcb, uint32_t segmentsAcked)
{
