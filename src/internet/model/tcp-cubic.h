...
private:
  ...
  bool     m_flagCSS;          //!< Enable or disable Cautious Slow Start algorithm
...
private:
  /**
   * \brief Cautious Slow start
   */
  uint32_t CSlowStart (Ptr<TcpSocketState> tcb, uint32_t segmentsAcked);
